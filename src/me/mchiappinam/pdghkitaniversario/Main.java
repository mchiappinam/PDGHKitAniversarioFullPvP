	...
	int task;
	  ...
	  public void onDisable() {
		...
		private void kit(Player p) {
			getServer().dispatchCommand(getServer().getConsoleSender(), "money give "+p.getName()+" 2");
			p.sendMessage("§aVocê recebeu 2 coins com sucesso!");
		}

		private void kitV(Player p) {
			getServer().dispatchCommand(getServer().getConsoleSender(), "money give "+p.getName()+" 25");
